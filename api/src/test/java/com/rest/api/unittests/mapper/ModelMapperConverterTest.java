package com.rest.api.unittests.mapper;
...
public class ModelMapperConverterTest {
    ...
    public void parseDTOToEntityTest() {
        Person output = ModelMapper.parseObject(inputObject.mockDTO(), Person.class);
        assertEquals(Long.valueOf(0L), output.getId());
        assertEquals("First Name Test0", output.getFirstName());
        assertEquals("Last Name Test0", output.getLastName());
        assertEquals("Addres Test0", output.getAddress());
    ...
    public void parserDTOListToEntityListTest() {
        ...
        List<Person> outputList = ModelMapper.parseListObjects(inputObject.mockDTOList(), Person.class);
